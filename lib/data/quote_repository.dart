...
class QuoteRepository extends BaseRepository<Quote> {
  ...
  // No hay un servicio real, implementamos una instancia mínima para satisfacer el BaseRepository
  @override
  dynamic get service => null;
  ...
  Future<List<Quote>> generateRandomQuotes(int count) async {
    // Usamos el método obtenerDatos para aprovechar el caché
    return obtenerDatos(
      fetchFunction: () async {
      ...
      cacheKey: 'random_quotes_$count',
      usarCache: false, // No usar caché para datos aleatorios
    );
  }
