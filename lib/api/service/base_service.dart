    ...
    _dio = Dio(
      BaseOptions(
        ...
        connectTimeout: const Duration(
          milliseconds: (ApiConstantes.timeoutSeconds * 1000),
        ),
  ...
  static ApiException handleError(DioException e, String endpoint) {
    ...
    switch (statusCode) {
      ...
      case 578:
        ...
        return ApiException(
          AppConstants.errorConexionProxy,
          statusCode: statusCode,
        );
      case 580:
        // Cliente desconectado (socket hang up)
        return ApiException(
          AppConstants.conexionInterrumpida,
          statusCode: 580,
        );
      case 581:
        // Error al recuperar archivo en Beeceptor
        return ApiException(
          AppConstants.errorRecuperarRecursos,
          statusCode: 581,
        );
      case 599:
        // Error crítico en Beeceptor
        return ApiException(
          AppConstants.errorCriticoServidor,
          statusCode: 599,
        );
      default:
        return ApiException(
  ...
  Future<Options> _getRequestOptions({bool requireAuthToken = true}) async {
    ...
    if (requireAuthToken) {
      ...
      if (jwt != null && jwt.isNotEmpty) {
        ...
        throw ApiException(AppConstants.tokenNoEncontrado, statusCode: 401);
      }
    }
